...
float computeInvariantMass(RVec<float>& pt, RVec<float>& eta, RVec<float>& phi, RVec<float>& mass) { 
    ...
    Parameters
    ----------
    RVec<float>& pt : Muon_pt of the dataframe
    RVec<float>& eta : Muon_eta of the dataframe
    RVec<float>& phi : Muon_phi of the dataframe
    RVec<float>& mass : Muon_mass of the dataframe
...
auto allquantities(ROOT::RDataFrame df){
    ...
    Parameters
    ----------
    ROOT::RDataFrame df: it takes a dataframe
