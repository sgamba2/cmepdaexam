...
void costheta_hist(){
    ...
    */
    ...
    coshisto(df_2mu_MCy1, "costheta1","#bf{0.0<|y_{#mu#mu}|<0.4}",0.45,0.80,0.65,0.86,"c1");
    coshisto(df_2mu_MCy2, "costheta2","#bf{1.2<|y_{#mu#mu}|<1.8}",0.6,0.82,0.8,0.88,"c2");
    coshisto(df_2mu_MCy3, "costheta3","#bf{1.6<|y_{#mu#mu}|<2.0}",0.7,0.80,0.9,0.86,"c3");
