...
void dimuon_spectrum_Z(){
    ...
    */
    ...
    constexpr int bins = 60; // Number of bins in the histogram
    constexpr float low = 70.0; // Lower edge of the histogram
    constexpr float up = 110.0; // Upper edge of the histogram
